...
module.exports = {
    ...
    async execute(message, args, discord) {
        ...
        if (!pollargs[1]) return message.channel.send("You need to state the vote message and time **(example: ;create.poll Do you like apples? | 5d )**")
        ...
        console.log("channelID:", msg.channel.id, ", messageID:", msg.id)
